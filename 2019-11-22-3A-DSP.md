...
##### 1.1 Descrivi il teorema del campionamento in un discorso che ne esponga le formule e le finalità. [5/30]la teoria del campionamento
```
il teorema del campionamento é quel teorema che stabilisce che un segnale analogico nel tempo s(t) che ha la banda di frequenza limitata da una frequenza massima fmax il segnale s(t) puo essere analizzato da csampioni che vengono presi dalla frequenza
fc>2fmax.
```
